...
def messages():
    ...
    return render_template('messages.html.j2', messages=messages.items,
...
def send_message(recipient):
    ...
    return render_template('send_message.html.j2', title=_('Send Message'),
...
def user_popup(username):
    ...
    form = EmptyForm()
    return render_template('user_popup.html.j2', user=user, form=form)
...
def search():
    ...
    prev_url = url_for('main.search', q=g.search_form.q.data, page=page - 1) \
        if page > 1 else None
    return render_template('search.html.j2', title=_('Search'), posts=posts,
                           next_url=next_url, prev_url=prev_url)
